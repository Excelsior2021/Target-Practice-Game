...
def check_events(settings, screen, stats, ship, target, bullets, play_button, hud):
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            check_keydown_events(event, screen, settings, ship, target, stats, bullets, hud)
...
def check_keydown_events(event, screen, settings, ship, target, stats, bullets, hud):
...
def update_screen(settings, screen, stats, ship, bullets, target, play_button, hud, m_line, clock, current_time):
